...
local monokai = {
    white = kitty_colors.white,
    grey = "#8F908A",
    darkgrey = kitty_colors.grey,
    black = "#000000",
    pink = kitty_colors.pink,
    green = kitty_colors.green,
    aqua = kitty_colors.aqua,
    cyan = "#A1EFE4",
    yellow = kitty_colors.yellow,
    orange = kitty_colors.orange,
    purple = kitty_colors.purple,
    red = "#e95678",
    purered = "#ff0000",
    darkred = "#5f0000",
    addfg = "#d7ffaf",
    ...
    bg = kitty_colors.black,
    border = "#504945",
    bg_popup = "#333842",
    bg_highlight = "#2E323C",
    fg = kitty_colors.white,
    fg_alt = "#5B6268",    none = "NONE"
}
